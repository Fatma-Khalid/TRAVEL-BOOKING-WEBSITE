...
<div class="header">
        <h1><i class="fa-solid fa-plane"></i>&nbsp;&nbsp;TRAVEL EXPLORER</h1>
                ...
                <div class="container">
                    ...
                    <div class="pic">
                        <img src="../zanzibar hotel/hot8.jpg" alt="">
                    </div>
       ...
       if(isset($_POST["submit"])){
        ...
        require_once "kiwengwabooking.php";
        ...
        if (count($errors)>0) {
         ...
         $sql = "INSERT INTO booking(fullname,phone,email,address,payment,dateIn,dateOut) VALUES ( ?, ?, ?, ?, ?, ?, ?)";
    ...
    <form action="kiwengwa.php" method="post">
    ...
    ?>
        <div class="head">
            ...
            <form action="kiwengwacancel.php" method="post">
            <div class="form-group">
                <input type="email" class="form-control" name="email" placeholder="Email:">
             </div>
             <div class="form-btn">
