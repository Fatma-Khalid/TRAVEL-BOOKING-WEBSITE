...
<div class="header">
        <h1><i class="fa-solid fa-plane"></i>&nbsp;&nbsp;TRAVEL EXPLORER</h1>
                ...
                <div class="container">
                    <div class="pic">
                        <img src="../zanzibar hotel/hot9.jpg" alt="">
                    </div>
                 <br>
                 <h4>PAJE DESTINATION
                 </h4>
       ...
       if(isset($_POST["submit"])){
        ...
        require_once "pajebooking.php";
        $sql = "SELECT * FROM pajedata WHERE email = '$email' ";
        ...
        if (count($errors)>0) {
         ...
         $sql = "INSERT INTO pajedata(fullname,phone,email,address,payment,dateIn,dateOut) VALUES ( ?, ?, ?, ?, ?, ?, ?)";
    ...
    <form action="paje.php" method="post">
    ...
    ?>
        <div class="head">
            ...
            <form action="pajecancel.php" method="post">
            <div class="form-group">
                <input type="email" class="form-control" name="email" placeholder="Email:">
             </div>
             <div class="form-btn">
